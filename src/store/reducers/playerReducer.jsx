import { SET_CURRENT_TRACK, SET_PLAY_STATUS, PLAY_PAUSE, PREVIOUS_TRACK, NEXT_TRACK, SET_TRACKS_DATA, SET_CURRENT_TRACK_INDEX, GET_CURRENT_TRACK_INDEX, SET_SHUFFLE, LIKE_TRACK, DISLIKE_TRACK, SET_LIKED_TRACKS } from '../actions/types/playerActionTypes.jsx';
